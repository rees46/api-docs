...
set :ios_sdk_repo, 'https://github.com/PersonaClick/ios-sdk.git'
set :android_sdk_package_name, 'PersonaClick'
set :android_sdk_package_code, 'personaclick'
set :rn_sdk_package_name, 'Personaсlick'
set :rn_sdk_package_code, '@personaclick'
